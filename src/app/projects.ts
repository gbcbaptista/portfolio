const projectsList = [
  ...
  },
  {
    ...
    description:
      "A deep dive into ML fundamentals where I build, debug, and refine algorithms from scratch. In the Titanic challenge, I implemented Logistic Regression using only NumPy, engineered complex features, and troubleshot numerical stability issues by creating a custom feature scaler, ultimately matching Scikit-learn's benchmark performance.",
